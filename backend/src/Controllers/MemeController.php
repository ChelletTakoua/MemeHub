...
class MemeController
{
    ...
    public function addMeme()
    {
        ...
        // Check if the request body is not empty, contains a 'template_id' key, and if the user is logged in
        if (!empty($requestBody) && isset($requestBody['template_id']) && isset($_SESSION['user_id'])) {
            // Try to add the meme to the database
            $meme = MemeTableManager::addMeme($requestBody['template_id'], "", $_SESSION['user_id']);
