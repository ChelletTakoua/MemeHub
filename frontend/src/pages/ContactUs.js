...
const Contact = () => {
  return (
    <div className="bg-palenight flex items-center justify-center h-screen text-white">
      <div className="bg-gray-800 shadow-md rounded px-16 pt-12 pb-12 mb-8 flex flex-col">
